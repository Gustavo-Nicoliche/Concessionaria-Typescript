...
class PessoaDao {
    ...
    remover(id) {
        ...
        return new Pessoa_1.default('', ''); // Retorna uma nova instância de Pessoa com dados vazios (a implementação real deve remover o objeto do banco de dados)
    }
    ...
    selecionar(id) {
        ...
        return new Pessoa_1.default('', ''); // Retorna uma nova instância de Pessoa com dados vazios (a implementação real deve buscar o objeto no banco de dados)
    }
    ...
    selecionarTodos() {
        ...
        return [new Pessoa_1.default('', '')]; // Retorna um array com uma instância de Pessoa com dados vazios (a implementação real deve retornar uma lista de objetos do tipo Pessoa)
    }
}
