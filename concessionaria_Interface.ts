export default interface concessionariaInterface {
    // Método obrigatório que todas as classes que implementarem esta interface devem possuir.
    fornecerHorariosDeFuncionamento(): string; // Retorna uma string com os horários de funcionamento.
}
